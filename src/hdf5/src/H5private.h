...
#ifdef __cplusplus
extern "C" int boost_first_thread_init(); /* defined in init_once_workaround.cpp */
#else
int boost_first_thread_init(); /* defined in init_once_workaround.cpp */
#endif
#define H5_FIRST_THREAD_INIT boost_first_thread_init();
#else
